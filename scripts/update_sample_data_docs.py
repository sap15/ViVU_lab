    ...
    schema = {
        ...
        "feature_notes": {
            "custom_structure_energy": (
                "Present in graph_features of the inspected HDF5 files and examples."
            ),
            "custom_complex_energy_phenotype": (
                "Not present in graph_features of local_data/hdf5/proc_483p.hdf5 "
                "or local_data/hdf5/wt_companion.hdf5 at the time this schema was generated. "
                "It should not be treated as part of the current HDF5 schema unless future HDF5 files "
                "are regenerated with this feature."
            ),
        },
